...
function solver
{
    ...
    case $task in
        "DC-CO")
            python $DIR/credulous_solver.py  $fileinput $task $additional 
        ;;
        "DC-PR")
            python $DIR/credulous_solver.py  $fileinput $task $additional 
        ;;
        ...
        #;;
        "DC-GR")
            python $DIR/grounded_solver.py  $fileinput $task $additional 
        ;;
        #"DC-ID")
        ...
        ;;
        "DS-PR")
            python $DIR/sceptical_solver.py  $fileinput $task $additional 
        ;;
        "DS-ST")
            python $DIR/sceptical_solver.py  $fileinput $task $additional 
        ;;
        ...
        #;;
        "EE-CO")
            python $DIR/enumerator.py  $fileinput $task 
        ;;
        "EE-PR")
            python $DIR/enumerator.py  $fileinput $task
        ;;
        ...
        #;;
        "EE-GR")
            python $DIR/grounded_solver.py  $fileinput $task
        ;;
        #"EE-ID")
